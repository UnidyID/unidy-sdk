...
class Newsletter {
    ...
    render() {
        return (hAsync("div", { key: '866673961c24bccb5fd232c8d3aa799540328fef', part: "container", class: "max-w-lg" }, hAsync("slot", { key: '2846a46c5801618c8439eb5a53ce72371d9d3e0f', name: "header" }), this.header && hAsync("h1", { key: '4e7c05b71329aed0963abfa2e85918abdab66724', part: "heading" }, this.header), hAsync("slot", { key: '8be08db3edb71455a87c90ff05b434c16b96a1ab', name: "description" }), hAsync("form", { key: '72dbbfb0f74577c1cd84a90760ed734e4bb5951f', onSubmit: this.handleSubmit, class: "flex flex-col gap-2" }, hAsync("div", { key: '725b5ca7c325943bae4d1130b992f91c534090ed', part: "email-input-group" }, hAsync("label", { key: '600e22645125a17ab12372dd1bd0b2bc1e32c2c5', part: "email-input-label", htmlFor: "email-input" }, this.emailLabel), hAsync("input", { key: '5793290d870469086fa5d46049ee90ce4ab7af6f', id: "email-input", type: "email", part: "email-input", required: true, placeholder: this.emailPlaceholder, value: this.email, onInput: (e) => {
            ...
            this.renderErrorMessage(this.newslettersConfig[0].internalName), hAsync("button", { key: '81909fa94be49a46983c878daac2af397b95ebf0', part: "submit-button", type: "submit", class: "w-full border" }, this.submitButtonText), this.showSubscribeSuccessSlot && hAsync("slot", { key: '88cdd69cd1b2cd375cbc1509d6ad6c7d8d3223d6', name: "success-container" }), this.showConfirmSuccessSlot && (hAsync("slot", { key: '802673041775a9ff137aec97f6b8a6f698816cb4', name: "confirm-success-container" }, hAsync("p", { key: '8fa25704bbef76ace615db76c432e1b62b0a1a2b', part: "confirm-success-text" }, this.successConfirmationText))), this.showConfirmationErrorSlot && (hAsync("slot", { key: 'fd65d25e00f703bb3220bb6646708c0947ced1aa', name: "confirmation-error-container" }, hAsync("p", { key: 'e6c668dc4cc2709b1988f260074f0f8f4811ff8c', part: "confirmaton-error-text" }, this.confirmationErrorText)))), hAsync("slot", { key: '934222ecc66f8a3a06ac111d6d7078258b0a38a8', name: "footer" })));
    }
