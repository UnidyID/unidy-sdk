...
declare global {
  ...
  interface HTMLUnidyNewsletterElement extends Components.UnidyNewsletter, HTMLStencilElement {
    addEventListener<K extends keyof HTMLUnidyNewsletterElementEventMap>(
      type: K,
      listener: (this: HTMLUnidyNewsletterElement, ev: UnidyNewsletterCustomEvent<HTMLUnidyNewsletterElementEventMap[K]>) => any,
    ...
    removeEventListener<K extends keyof HTMLUnidyNewsletterElementEventMap>(
      type: K,
      listener: (this: HTMLUnidyNewsletterElement, ev: UnidyNewsletterCustomEvent<HTMLUnidyNewsletterElementEventMap[K]>) => any,
