  ...
  outputTargets: [
    ...
    },
    {
      ...
      copy: [
        ...
        { src: "../../components/dist/per-component/unidy-newsletter.js", dest: "newsletter/unidy-newsletter.js" },
        { src: "../../components/dist/per-component/index.js", dest: "newsletter/index.js" },
      ],
    },
  ],
  plugins: [tailwind()],
