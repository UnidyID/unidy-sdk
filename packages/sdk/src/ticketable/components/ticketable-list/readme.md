...
| `store`                       | --                  | Pagination store instance for external state management. Created automatically when not provided. | `{ state: PaginationState; onChange: <K extends keyof PaginationState>(prop: K, cb: (newValue: PaginationState[K]) => void) => () => void; reset: () => void; }` | `null`      |
...
| ------------------------ | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `uTicketableListError`   | Fired when fetching items fails. Contains the error message.                       | `CustomEvent<{ ticketableType?: TicketableType; error: string; }>`                                                                                                                       |
