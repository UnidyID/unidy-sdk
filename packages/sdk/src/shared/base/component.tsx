 ...
 * Components extending this class get a `this.element` property that automatically returns the component's host element.
 */
export const UnidyComponent = <T extends ((base: MixedInCtor) => MixedInCtor)[]>(...mixins: T) => {
