...
| `for`                | `for`        | The action type for the button. Varies by context (auth: email/password/magic-code/reset-password, newsletter: subscribe/login). | `"acceptInvitation" \| "create" \| "email" \| "login" \| "password" \| "resetPassword" \| "single-login"` | `undefined` |
