...
import { t } from "../../../i18n";
import { buttonContent, hasSlotContent } from "../../../shared/component-utils";
  ...
  render() {
    return (
      <button type="button" disabled={this.isDisabled()} class={this.componentClassName} onClick={this.handleClick} aria-live="polite">
        {buttonContent({ hasSlot: this.hasSlot, loading: this.loading, defaultText: t("buttons.jump_to_service") })}
      </button>
    );
  }
}
