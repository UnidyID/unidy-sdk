...
| `provider`    | `provider`     | The OAuth provider (google, linkedin, apple, discord, facebook, unidy, or oidc_<slug> for OpenID Connect providers). | `` "apple" \| "discord" \| "facebook" \| "google" \| "linkedin" \| "unidy" \| `oidc_${string}` `` | `"google"`             |
